...
public class Digit_7_Tests {
	...
	public void matchesPattern0() throws Exception {
		assertThat(target.isMatch(Patterns.PATTERN_7), is(true));
	}
	...
	public void doesntMatchAnyOtherWellKnownPatterns() throws Exception {
		...
		assertThat(target.isMatch(Patterns.PATTERN_4), is(false));
